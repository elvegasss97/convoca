...
import {
	...
	listTopicEvaluationMoments,
	listTopicMeasureChangeConditions
...
export const load: PageLoad = async ({ params }) => {
	...
	const [
		...
		listTopicEvaluationMoments(topic.id),
		listTopicMeasureChangeConditions(topic.id)
	]);
