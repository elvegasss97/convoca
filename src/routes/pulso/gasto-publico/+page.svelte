	...
	>
		...
		<div class="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
			<div class="max-w-3xl">
				...
				>
					<ShieldCheck class="size-3.5" /> Piloto con fuentes primarias
				</div>
			...
			<div class="grid shrink-0 grid-cols-2 gap-2 sm:min-w-md">
				<div class="rounded-2xl border border-white/10 bg-white/10 px-4 py-3 backdrop-blur-sm">
					<p class="text-[11px] font-medium tracking-wide text-brand-200 uppercase">Caso piloto</p>
					<p class="mt-1 font-display text-lg font-semibold">1 resolución</p>
				</div>
				<div class="rounded-2xl border border-white/10 bg-white/10 px-4 py-3 backdrop-blur-sm">
					<p class="text-[11px] font-medium tracking-wide text-brand-200 uppercase">Fuentes</p>
					<p class="mt-1 font-display text-lg font-semibold">3 oficiales</p>
				</div>
		...
		<div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
			<div class="max-w-3xl">
				<div class="flex items-center gap-2 text-accent-700">
					<Info class="size-5" />
					<p class="text-xs font-semibold tracking-wider uppercase">Alcance de esta V0</p>
				</div>
				<h2 class="mt-2 font-display text-xl font-semibold text-ink-900">
					Una investigación completa, no un inventario completo
				</h2>
				<p class="mt-2 text-sm leading-relaxed text-ink-600">
					Este piloto prueba la experiencia y la metodología con un expediente estatal. El siguiente
					paso es incorporar asignaciones, entidades y territorio sin rebajar el nivel de evidencia.
				</p>
			</div>
			<a
				href="/pulso"
			...
			>
				Volver a Pulso <ArrowRight class="size-3.5" />
			</a>
		</div>
	</section>
</div>
