...
>
	...
	<section>
		...
		<ul>
			<li>
				...
				queda protegida mediante hash), o tu identificador de Google si inicias sesión así. Para poder
				darte acceso a tu cuenta y a las funciones que requieren estar identificado.
			</li>
			<li>
				<strong>Perfil de organizador (público):</strong> nombre visible, tipo de organización y nivel
				de verificación. Para que quien vea tus convocatorias sepa quién las publica.
			</li>
			<li>
			...
			<li>
				<strong>Muro municipal y recogidas ciudadanas:</strong> el título, la petición, el municipio,
				el destinatario y demás contenido que una persona decide publicar son públicos. La cuenta que
				abre una recogida queda vinculada internamente para prevención de abuso y gestión de la iniciativa,
				pero su identificador no se publica. Si esa cuenta se elimina, la vinculación se anonimiza y la
				recogida puede conservarse como contenido público.
			</li>
			<li>
				<strong>Apoyos a recogidas municipales:</strong> para impedir apoyos duplicados, permitir
				que puedas retirarlos y calcular el recuento agregado, guardamos internamente la relación
				entre tu cuenta y la petición que apoyas, junto con la fecha y la versión del aviso de
				consentimiento aceptado.
				<strong
					>Tu identidad no se muestra públicamente ni se entrega a quien creó la recogida</strong
				>. Según el asunto de una petición, esa relación podría revelar información especialmente
				sensible, por ejemplo una opinión política; por eso, antes de registrar cada nuevo apoyo te
				pedimos un consentimiento explícito y específico. Retirar el apoyo elimina esa relación
				activa.
			</li>
			<li>
			...
			<li>
				<strong>Reportes y moderación:</strong> si reportas una convocatoria, una recogida municipal o
				un canal, guardamos el motivo, el detalle opcional y, si estás identificado, tu cuenta, para poder
				gestionar el reporte y prevenir abuso del sistema. En la cola municipal la identidad de quien
				reporta no se entrega a la interfaz de moderación. El historial de decisiones de moderación es
				interno y nunca público; evita copiar en él texto ciudadano o identidades que no sean necesarias.
			</li>
			<li>
				<strong>Pistas sobre gasto público:</strong> si nos pides investigar una partida, guardamos de
				forma privada el título, la explicación, los enlaces públicos y los datos opcionales de importe,
				organismo y territorio que decidas aportar. La pista queda vinculada internamente a tu cuenta
				para prevenir abuso y gestionar el triaje, pero no se publica ni se atribuye a tu perfil. Una
				ficha editorial resultante se redacta a partir de fuentes verificadas, sin copiar tu identidad
				ni datos personales innecesarios.
			</li>
			<li>
				<strong>Datos técnicos:</strong> dirección IP y registros técnicos de acceso, gestionados por
	...
	<section>
		...
		<ul>
			<li>
				...
				el servicio que solicitas al registrarte.
			</li>
			<li>
				<strong>Consentimiento:</strong> los documentos de verificación y las pistas sobre gasto público
				que aportas de forma voluntaria, el inicio de sesión con Google y, de forma separada y explícita,
				la vinculación interna de tu cuenta con cada apoyo municipal que decidas registrar. Puedes retirar
				ese último consentimiento retirando el apoyo desde la propia ficha. Cuando el contenido apoyado
				pudiera revelar categorías especiales de datos, ese consentimiento explícito es la base prevista
				para dicho tratamiento.
			</li>
			<li>
				<strong>Interés legítimo:</strong> los registros técnicos de seguridad, la prevención de abuso
				y las decisiones de moderación.
			</li>
			<li>
				<strong>Obligación legal:</strong> cuando debamos conservar o ceder algún dato porque así lo exija
	...
	<section>
		...
		<p>
			Estos proveedores pueden procesar datos en centros fuera del Espacio Económico Europeo. En ese
			caso, se apoyan en las garantías previstas por el RGPD (como las cláusulas contractuales tipo
			de la Comisión Europea). Nunca compartimos tus datos con terceros con fines publicitarios.
		</p>
	</section>
	<section>
		...
		<p>
			...
			legal (por ejemplo, el registro de decisiones de moderación, que se conserva de forma interna
			y sin datos identificativos innecesarios). Las pistas privadas sobre gasto público vinculadas
			a tu cuenta se eliminan con ella; una investigación editorial ya publicada puede conservarse
			porque se basa en fuentes públicas verificadas y no incluye tu identidad. Las recogidas
			municipales que hayas publicado pueden seguir visibles como contenido ciudadano, pero se
			elimina su vínculo identificativo con tu cuenta. Los apoyos que sigan vinculados a una cuenta
			se conservan mientras el apoyo permanezca activo; al retirarlo se elimina la fila que
			relaciona esa cuenta con esa petición.
		</p>
	</section>
	<section>
		...
		<p>
			...
			oposición, limitación y portabilidad de tus datos, escribiendo a <a
				href="mailto:contacto@convoca.cloud">contacto@convoca.cloud</a
	...
	<section>
		...
		<p>
			...
			restringido por reglas de autorización aplicadas a nivel de base de datos (no solo en la
			interfaz), de forma que ni siquiera una llamada directa a la API salta esas restricciones.
		</p>
	</section>
	<section>
		...
		<p>
			...
			política de privacidad. No usamos cookies de publicidad ni de seguimiento con terceros.
		</p>
	</section>
	<section>
