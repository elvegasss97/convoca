-- ============================================================================
-- 0042_security_hardening_review3.sql (CANDIDATA — NO_EJECUTAR_SIN_REVISAR)
--
-- Tercera revisión. NO aplicada a ninguna base de datos por esta auditoría.
-- NO es una migración existente del repo — es un archivo candidato guardado
-- en /seguridad; si se decide aplicar, debe copiarse a
-- supabase/migrations/0042_*.sql y pasar primero por staging.
--
